...
public class GpsSubParser extends SubParser {
     ...
     */
    public GpsSubParser( Chapter chapter,Scene scene ) {
        ...
        if( subParsing == SUBPARSING_NONE ) {
            ...
            if( sName.equals( "gps" ) ) {
               ...
               String id="";
                ...
                Gpsrule.setUsesEndCondition(usesEndCondition);
    ...
    public void endElement( String namespaceURI, String sName, String qName ) {
        ...
        // If an effect is being subparsed
            ...
            if( sName.equals( "post-effect" ) ) {
                Gpsrule.setPostEffects( currentEffects );
                subParsing = SUBPARSING_NONE;
            }
        }
    }
