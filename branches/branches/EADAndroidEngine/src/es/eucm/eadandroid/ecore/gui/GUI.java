...
public class GUI {
	...
	public void addPlayerToDraw(Bitmap image, int x, int y, int depth,
		...
		while (!added && i < elementsToDraw.size()) {
			...
			//if (depth <= elementsToDraw.get(i).getDepth()) { //TODO esto lo  entiendo pero me imagino que el euge lo pilota
...
//TODO habra que eliminar todo
    ...
    *//**
    ...
    public static void drawString( Canvas g, String[] strings, int x, int y ) {
        ...
        int textBlockHeight = (int) (mPaint.getTextSize() * strings.length - mPaint.getFontMetrics().leading - mPaint.descent());
