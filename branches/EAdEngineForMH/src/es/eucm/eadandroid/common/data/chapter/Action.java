...
public class Action implements Cloneable, Documented, HasTargetId {
    ...
    /**
     * Effects to be triggered when user fails choosing the target of interaction (give to, drag, use with, custom interaction) 
     */
    private Effects clickFailEffects;
    
    
    /**
     * Activate click effects
     */
    private boolean activatedClickEffects = false;
    
    /**
     * Activate fail click effects
     */
    private boolean activatedFailClickEffects = false;
    //OLD FIN
    ...
    public Action( int type, String idTarget, Conditions conditions, Effects effects, Effects notEffects ,
    		//OLD INICIO
    		Effects clickEffects, Effects clickFailEffects){
    		//OLD FIN 
        ...
        this.clickFailEffects = clickFailEffects;
        //OLD FIN
        documentation = null;
    }
    ...
    //OLD INICIO
    public Effects getClickFailEffects( ) {
        
        return clickFailEffects;
    }

    
    public void setClickFailEffects( Effects clickFailEffects ) {
    
        this.clickFailEffects = clickFailEffects;
    }

    
    public boolean isActivatedFailClickEffects( ) {
    
        return activatedFailClickEffects;
    }

    
    public void setActivatedFailClickEffects( boolean activatedFailClickEffects ) {
    
        this.activatedFailClickEffects = activatedFailClickEffects;
    }    
