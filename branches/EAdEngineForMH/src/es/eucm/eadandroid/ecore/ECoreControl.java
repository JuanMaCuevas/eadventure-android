...
public class ECoreControl extends Activity {
	...
	public static final int REQUEST_RPLAYER=2;
	...
	public class ActivityHandlerMessages {
		...
		public static final int INSTALLED_RPLAYER = 2;
	...
	public Handler ActivityHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case ActivityHandlerMessages.INSTALLED_RPLAYER: 
				changeActivity();
				break;			
	...
	private void checkRockPlayer() {
		...
		final boolean scanAvailable = isIntentAvailable(this,"com.redirectin.rockplayer.android.unified.lite");
	...
	private void showRockPlayerDialog() {
		new AlertDialog.Builder(this)
				.setTitle("eAdventure Video Playback")
				.setIcon(R.drawable.dialog_icon)
				.setMessage(
						"You need to install RockPlayer Lite app in order to play eAdventure video assets")
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								Intent i = new Intent(
										Intent.ACTION_VIEW,
										Uri
												.parse("market://search?q=pname:com.redirectin.rockplayer.android.unified.lite"));
														
								startActivityForResult(i, REQUEST_RPLAYER);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		super.onActivityResult(requestCode, resultCode, data); 
		 ...
		 case (REQUEST_RPLAYER): {
			 final boolean scanAvailable = isIntentAvailable(this,
				"com.redirectin.rockplayer.android.unified.lite");

			 if (!scanAvailable) {

				 this.showRockPlayerDialog();
			 } else {

				 Message msg = ActivityHandler.obtainMessage();
				 Bundle b = new Bundle();
				 msg.what = ActivityHandlerMessages.INSTALLED_RPLAYER;
				 msg.setData(b);
				 msg.sendToTarget();
			 }
			 break;
