...
public abstract class ConversationNode implements ConversationNodeView {
     ...
     * (non-Javadoc)
     * 
     * @see es.eadengine.common.data.chapterdata.conversation.node.ConversationNodeView#getChildView(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see es.eadengine.common.data.chapterdata.conversation.node.ConversationNodeView#isPlayerLine(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see es.eadengine.common.data.chapterdata.conversation.node.ConversationNodeView#getLineName(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see es.eadengine.common.data.chapterdata.conversation.node.ConversationNodeView#getLineText(int)
     */
