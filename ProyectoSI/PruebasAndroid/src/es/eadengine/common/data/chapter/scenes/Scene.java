 ...
 * 
 */
package es.eadengine.common.data.chapter.scenes;

import java.util.ArrayList;
import java.util.List;

import es.eadengine.common.data.Positioned;
import es.eadengine.common.data.chapter.ElementReference;
import es.eadengine.common.data.chapter.Exit;
import es.eadengine.common.data.chapter.Trajectory;
import es.eadengine.common.data.chapter.elements.ActiveArea;
import es.eadengine.common.data.chapter.elements.Barrier;
