 ...
 */
public class Game3 implements KeyListener, MouseListener, MouseMotionListener, Runnable, TimerEventListener, SpecialAssetPaths {
...
//            GUI.getInstance( ).endDraw( );
            ...
            ReportDialog.GenerateErrorReport( e, Game3.getInstance( ).isFromEditor( ), "FATAL ERROR. This should not happen." );
        }
