...
public class GUI {
   ...
   //OLD protected HUD hud;
    ...
    protected class Text {
         ...
         *            Color of the borde of the text
         */
        public Text( String[] text, int x, int y, int textColor, int borderColor, int bubbleBkgColor, int bubbleBorderColor, boolean showArrow ) {
...
/*		if( instance instanceof GUIFrame )
  ...
  //OLD  public abstract JFrame showComponent( Component component, int w, int h );
     ...
     *            Depth of the image
     */
    public void addElementToDraw( Bitmap image, int x, int y, int depth, int originalY, FunctionalHighlight highlight, FunctionalElement fe ) {
     ...
     *            Depth of the image
     */
    public void addPlayerToDraw( Bitmap image, int x, int y, int depth, int originalY ) {
     ...
     */
    public void addTextToDraw( String[] string, int x, int y, int textColor, int borderColor, int bubbleBkgColor, int bubbleBorderColor, boolean showArrow  ) {
