 ...
 * 
 */
package es.eadengine.common.loader.subparsers;

import org.xml.sax.Attributes;

import es.eadengine.common.data.chapter.Chapter;
import es.eadengine.common.data.chapter.conditions.Conditions;
import es.eadengine.common.data.chapter.effects.AbstractEffect;
import es.eadengine.common.data.chapter.effects.ActivateEffect;
import es.eadengine.common.data.chapter.effects.CancelActionEffect;
import es.eadengine.common.data.chapter.effects.ConsumeObjectEffect;
import es.eadengine.common.data.chapter.effects.DeactivateEffect;
import es.eadengine.common.data.chapter.effects.DecrementVarEffect;
import es.eadengine.common.data.chapter.effects.Effects;
import es.eadengine.common.data.chapter.effects.GenerateObjectEffect;
import es.eadengine.common.data.chapter.effects.HighlightItemEffect;
import es.eadengine.common.data.chapter.effects.IncrementVarEffect;
import es.eadengine.common.data.chapter.effects.MacroReferenceEffect;
import es.eadengine.common.data.chapter.effects.MoveNPCEffect;
import es.eadengine.common.data.chapter.effects.MoveObjectEffect;
import es.eadengine.common.data.chapter.effects.MovePlayerEffect;
import es.eadengine.common.data.chapter.effects.PlayAnimationEffect;
import es.eadengine.common.data.chapter.effects.PlaySoundEffect;
import es.eadengine.common.data.chapter.effects.RandomEffect;
import es.eadengine.common.data.chapter.effects.SetValueEffect;
import es.eadengine.common.data.chapter.effects.ShowTextEffect;
import es.eadengine.common.data.chapter.effects.SpeakCharEffect;
import es.eadengine.common.data.chapter.effects.SpeakPlayerEffect;
import es.eadengine.common.data.chapter.effects.TriggerBookEffect;
import es.eadengine.common.data.chapter.effects.TriggerConversationEffect;
import es.eadengine.common.data.chapter.effects.TriggerCutsceneEffect;
import es.eadengine.common.data.chapter.effects.TriggerLastSceneEffect;
import es.eadengine.common.data.chapter.effects.TriggerSceneEffect;
import es.eadengine.common.data.chapter.effects.WaitTimeEffect;
