 ...
 * 
 */
package es.eadengine.common.data.chapter.conversation.node;

import java.util.ArrayList;
import java.util.List;

import es.eadengine.common.data.chapter.conditions.Conditions;
import es.eadengine.common.data.chapter.conversation.line.ConversationLine;
...
public class DialogueConversationNode extends ConversationNode {
     ...
     * (non-Javadoc)
     * 
     * @see es.eadengine.common.data.chapterdata.conversation.node.ConversationNodeView#getType()
     */
    public int getType( ) {
     ...
     * (non-Javadoc)
     * 
     * @see es.eadengine.common.data.chapterdata.conversation.node.ConversationNodeView#isTerminal()
     */
     ...
     * (non-Javadoc)
     * 
     * @see es.eadengine.common.data.chapterdata.conversation.node.ConversationNodeView#getChildCount()
     */
     ...
     * (non-Javadoc)
     * 
     * @see es.eadengine.common.data.chapterdata.conversation.node.ConversationNodeView#getLineCount()
     */
     ...
     * (non-Javadoc)
     * 
     * @see es.eadengine.common.data.chapterdata.conversation.node.ConversationNodeView#hasEffects()
     */
