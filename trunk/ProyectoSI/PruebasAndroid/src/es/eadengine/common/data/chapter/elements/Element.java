 ...
 * 
 */
package es.eadengine.common.data.chapter.elements;

import java.util.ArrayList;
import java.util.List;

import es.eadengine.common.data.Described;
import es.eadengine.common.data.Detailed;
import es.eadengine.common.data.Documented;
import es.eadengine.common.data.HasId;
import es.eadengine.common.data.Named;
