 ...
 * 
 */
package es.eadengine.common.data.chapter;

import java.util.ArrayList;
import java.util.List;

import es.eadengine.common.data.HasTargetId;
import es.eadengine.common.data.adaptation.AdaptationProfile;
import es.eadengine.common.data.adventure.ChapterSummary;
import es.eadengine.common.data.assessment.AssessmentProfile;
import es.eadengine.common.data.chapter.book.Book;
import es.eadengine.common.data.chapter.conditions.GlobalState;
import es.eadengine.common.data.chapter.conversation.Conversation;
import es.eadengine.common.data.chapter.effects.Macro;
import es.eadengine.common.data.chapter.elements.Atrezzo;
import es.eadengine.common.data.chapter.elements.Item;
import es.eadengine.common.data.chapter.elements.NPC;
import es.eadengine.common.data.chapter.elements.Player;
import es.eadengine.common.data.chapter.scenes.Cutscene;
import es.eadengine.common.data.chapter.scenes.GeneralScene;
import es.eadengine.common.data.chapter.scenes.Scene;
