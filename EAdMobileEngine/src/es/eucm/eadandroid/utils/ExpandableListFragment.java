...
public class ExpandableListFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
    	...
    	LinearLayout lroot = new LinearLayout(getActivity());
    	
    	TextView txt = new TextView(getActivity());
    	txt.setTextAppearance(getActivity(), attr.textAppearanceLarge);
    	txt.setGravity(Gravity.CENTER_VERTICAL|Gravity.CENTER_HORIZONTAL);
    	txt.setText("Load Saved Games");    	
    	lroot.addView(txt, new FrameLayout.LayoutParams(
        ...
        ExpandableListView.LayoutParams lp = new ExpandableListView.LayoutParams(
                ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT);
    ...
    public void onListItemClick(ExpandableListView l, View v, int position, long id) {
    	...
    	Log.d("PASAMOS POR AQUI", "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
    }
    ...
    private void ensureList() {
        ...
        if (root instanceof ExpandableListView) {
            ...
            mListContainer = root; //root.findViewById(R.id.listContainer);
